...
* Download [`Npp7.8.1_32bit_PyPadPlusPlus1.2.2.zip`](https://github.com/bitagoras/PyPadPlusPlus/releases/download/v1.2.2/Npp7.8_32bit_PyPadPlusPlus1.2.2.zip), unzip it into a folder and start `notepad++.exe`.
