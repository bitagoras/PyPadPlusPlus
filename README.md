...
* Download [`Npp7.8_32bit_PyPadPlusPlus1.2.zip`](https://github.com/bitagoras/PyPadPlusPlus/releases/download/1.2/Npp7.8_32bit_PyPadPlusPlus1.2.zip), unzip it into a folder and start `notepad++.exe`.
