...
* Download [`Npp7.7_32bit_PyPadPlusPlus1.1.1.zip`](https://github.com/bitagoras/PyPadPlusPlus/releases/download/1.1.1/Npp7.7_32bit_PyPadPlusPlus1.1.1.zip), unzip it into a folder and start `notepad++.exe`.
